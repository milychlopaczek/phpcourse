 ...
 * SETTINGS!
 */
$databaseName = 'shipsdb';
$databaseUser = 'root';
$databasePassword = 'hhhh';

/*
 * CREATE THE DATABASE
 */
$pdoDatabase = new PDO("mysql:host= 'shipdb'; port=33306; dbname=$databaseName; charset=utf8mb4", $databaseUser, $databasePassword);
 ...
 * CREATE THE TABLE
 */
$pdo = new PDO("mysql:host=shipsdb; port=33306 ;dbname=$databaseName; charset=utf8mb4", $databaseUser, $databasePassword);
